    ...
    <main class="w-full grid grid-cols-1 xl:grid-cols-2 min-h-screen">
      <div class="flex justify-center items-center bg-white">
        ...
        <div class="max-w-2xl mx-auto px-5 py-5 w-full">
          ...
          <form action="#" class="w-full flex flex-col mt-20 text-2xl text-dark/70">
            ...
            <div class="flex justify-between mt-5">
              <div class="flex gap-2.5 items-center">
                <input type="checkbox" id="remember_me" class="bg-gray-300 rounded-xl py-4 px-6 h-6 w-6">
            ...
            <button class="bg-primary rounded-xl py-4 text-white mt-10 cursor-pointer">Registar</button>

            <p class="text-center text-gray-500 mt-10">Não tem uma conta? <a href="register.html" class="text-primary">Registe-se aqui.</a></p>
          </form>
        </div>
      </div>
