    ...
    <main class="w-full grid grid-cols-1 xl:grid-cols-2 min-h-screen">
      <div class="flex justify-center items-center bg-white">
        ...
        <div class="max-w-2xl mx-auto px-5 py-5 w-full">
          ...
          <p class="text-center text-2xl mt-2">Digite suas credenciais para iniciar a sessão.</p>
          ...
          <form wire:submit.prevent="login" class="w-full flex flex-col mt-20 text-2xl text-dark/70">
            ...
            <div class="flex flex-col gap-2.5">
              ...
              <input wire:model="email_or_phone" type="text" id="email_or_phone" placeholder="Digite o seu ou número de celular" class="bg-gray-200 rounded-xl py-4 px-6 @error('email_or_phone') border-2 border-red-500 @enderror @error('invalid_credentials') border-2 border-red-500 @enderror">
            </div>
            ...
            <div class="flex justify-between mt-5">
              <div class="flex gap-2.5 items-center">
                ...
                <label for="remember_me">Manter sessão iniciada</label>
              </div>

              <a href="#" class="text-primary">Esqueceu a senha?</a>
            </div>

            <button type="submit" class="bg-primary rounded-xl py-4 text-white mt-10 cursor-pointer">Iniciar sessão</button>
      ...
      <div id="auth-image-container" class="bg-no-repeat bg-bottom relative hidden xl:block">
        <div class="absolute bottom-14 left-14 w-xl text-white">
          <h2 class=" font-black text-6xl">Aqui compras <span class="text-primary">eletrônicos & eletrodomésticos</span></h2>
