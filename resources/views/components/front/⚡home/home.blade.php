    ...
    <main class="px-5 mt-10">
      <div class="container mx-auto flex flex-col justify-center items-center">
        <div class="search-bar w-full max-w-5xl">
          <form wire:submit.prevent="searchProducts" class="flex w-full gap-5">
            <input wire:model="search_term" type="text" placeholder="Pesquisar por qualquer eletrônico ou eletrodoméstico" class="bg-gray-200 border-2 border-dark-green rounded-xl min-w-0 grow text-xl px-5 py-4">
            <button type="submit" class="bg-primary py-4 px-8 rounded-lg cursor-pointer">
        ...
        <div class="w-full flex flex-wrap justify-center gap-5 mt-10">
          @if($products->isEmpty())
            <p class="text-center text-gray-400">Não encontramos nenhum produto.</p>
          @endif
