      ...
      <div class="container mx-auto flex flex-col justify-center items-center">
        <div class="search-bar w-full max-w-5xl">
          <form action="#" class="flex w-full gap-5">
            <input type="text" placeholder="Pesquisar por qualquer eletrônico ou eletrodoméstico" class="bg-gray-200 border-2 border-dark-green rounded-xl min-w-0 grow text-xl px-5 py-4">
