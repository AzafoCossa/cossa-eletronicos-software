...
Route::livewire('/products/{product:slug}', 'front.products.view')->name('products.view');
...
Route::middleware('auth')->group(function(){
    ...
    Route::livewire('/orders/{order}', 'front.orders.order')->name('orders.order');
    ...
    Route::middleware('role:Admin|Manager')->prefix('dashboard')->name('dashboard.')->group(function(){
        ...
        Route::livewire('/orders', 'dashboard.orders')->name('orders');
        ...
        Route::livewire('/searches', 'dashboard.searches')->name('searches');
